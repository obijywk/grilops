...
def If(a: BoolRef, b: ExprRefOrLiteral, c: ExprRefOrLiteral) -> ExprRefOrLiteral: ...
...
def BV2Int(a: BitVecRef) -> IntNumRef: ...
def Concat(*args: BitVecRef) -> BitVecRef: ...
def Extract(high: int, low: int, bv: BitVecRef) -> BitVecRef: ...
